...
<template>
  <div class="h-screen flex flex-col items-center justify-center">
    <div class="full-container" v-if="sala && kick == false">
      ...
      <h1 class="text-h1 font-weight-black" v-if="myId == sala.owner">
        Codi sala: {{ sala.codi }}
      </h1>
      <h2 class="text-h2 font-weight-black" v-else>
      ...
      <div v-if="myId == sala.owner && playing == false">
        <v-checkbox
          label="Vols unir-te a la partida?"
          class="rounded mt-3 pr-2"
          :class="{ highlight: canPlay }"
          color="blue"
