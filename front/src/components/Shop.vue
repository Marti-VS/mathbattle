  ...
  <div>
    <div class="absolute top-0 right-0 mt-8 md:mr-[105px] mr-[100px]">
      <div>
        ...
        >
          <img
            :src="avatars[getState().usuari.avatar].image"
            class="scale-150"
          />
        </button>
        <div v-show="dialog" activator="info-svg">
          ...
          ></div>
          <div
            class="relative bg-white rounded-xl shadow-xl pt-8 pb-6 px-4 z-50 top-10"
          >
            <div>
            ...
            <div
              class="grid grid-cols-3 gap-6 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-6"
            >
              ...
              <div v-for="(avatar, index) in avatars" :key="index">
                ...
                <div class="flex items-center justify-center p-4">
                  ...
                  <button
                    v-if="getState().usuari.avatar == index && loading == false"
                  ...
                  >
                    <span
                      class="icon-[line-md--loading-twotone-loop] h-6"
                    ></span>
                  </button>
                </div>
              </div>
