...
<template>
  <div class="h-screen bg-[radial-gradient(rgba(173,216,230)_30%,rgba(81,180,213)_100%)]">
      ...
      <div class="absolute w-full h-full flex items-center justify-center top-0">
        ...
        " class="text-red-500 text-sm">{{ errors }}</span>
                ...
                <div class="flex justify-between mt-2">
                  <button type="button" class="button-pop-up bg-red-400 hover:opacity-80 mr-3"
                    @click="mostrarPopUp = !mostrarPopUp">
                    CANCELAR
                  </button>
                  <button type="submit" class="button-pop-up bg-blue-400 hover:hover:opacity-80">
                    ACCEPTAR
                  </button>
                </div>
              </form>
    ...
    <div class="mt-12 p-12 grid xl:grid-cols-4 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-5">
      <div v-for="classe in classes" :key="classe.idClasse"
          ...
          <div class="mt-24">
            ...
            <div class="mt-2">
              ...
              <div class="flex gap-3">
                <button class="button-pop-up bg-[#72bae8] focus:bg-[#5a97bd] text-white rounded-full p-2 mt-4 h-fit"
                ...
                <div class="flex items-center justify-center w-full h-full">
                  <div class="p-4">
                    <select v-model="selectedDificultats[classe.idClasse]"
                      class="border border-gray-300 rounded p-3 min-w-36 w-full" @change="
    ...
    <div v-if="mostrarCrearDificultat">
      <div class="fixed inset-0 bg-gray-900 opacity-25 z-10" v-on:click="
          {
          ...
          <div class="bg-white rounded p-4">
            ...
            <form @submit.prevent="saveDifficulty">
              <div class="mb-4">
                ...
                <input type="text" placeholder="La meva dificultat" v-model="nuevaDificultatNombre"
      ...
      <div class="absolute w-full h-full flex items-center justify-center top-0">
        ...
        " />
            ...
            <div class="flex justify-between mt-4">
              ...
              <button type="submit" class="button-pop-up bg-[#72bae8] hover:bg-blue-500">
                ACCEPTAR
              </button>
            </div>
          </form>
